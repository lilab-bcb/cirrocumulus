...
import {
  setDistributionPlotInterpolator,
...
function DistributionPlots(props) {
  ...
  return keys.map((key) => {
    ...
    if (distributionPlotOptions[key] == null) {
      distributionPlotOptions[key] = Object.assign({}, DIST_PLOT_OPTIONS, {
        chartType: 'heatmap',
      });
    ...
    return (
      <div key={key}>
        ...
        {Object.keys(dimension2data).map((dimension) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(DistributionPlots);
