  ...
  const comparisonOptions = [
    {
      label: 'All Pairs',
      value: 'pairs',
      title: 'Compare all pairs of groups',
    },
    {
      label: 'One vs. Rest',
      value: 'one_vs_rest',
      title: 'Compare group to all other groups',
    },
  ...
  return (
    <>
      ...
      >
        ...
        <DialogActions>
          <Button onClick={onSubmitJobCancel}>Cancel</Button>
          <Button
            disabled={jobName === ''}
            variant="contained"
            onClick={(e) => onSubmitJobOK(jobName)}
            color="primary"
          >
            Submit
          </Button>
          ...
          {comparisonsOption !== 'selection' && (
            <FormControl sx={{display: 'block'}}>
              <AutocompleteVirtualized
                ...
                helperText={
                  'Select two or more categories to combine categories using "AND"'
                }
