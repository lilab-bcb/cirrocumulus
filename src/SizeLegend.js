...
export function drawSizeLegend(
  context,
  scale,
  nsteps,
  width,
...
class SizeLegend extends React.PureComponent {
  ...
  redraw() {
    ...
    context.clearRect(0, 0, width * backingScale, height * backingScale);
  ...
  render() {
    ...
    return (
      <canvas
        width={width * backingScale}
        height={height * backingScale}
        ref={this.ref}
        style={style}
      ></canvas>
    );
